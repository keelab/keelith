...
// RetentionConfig bounds one scheduled PostgreSQL Outbox cleanup.
...
// RetentionResult reports whether one bounded run drained eligible rows.
...
// RetentionRuntime runs bounded cleanup against an existing Outbox Runtime.
...
// NewRetentionRuntime composes maintenance with the exact Outbox Repository.
...
// Run removes at most BatchSize*MaxBatches rows using one stable cutoff.
