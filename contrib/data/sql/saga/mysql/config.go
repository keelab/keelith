...
var (
	...
	ErrDefinitionRegistered = errors.New("mysql saga: definition registered")
	// ErrDefinitionsFrozen reports registration after the first Start attempt.
	ErrDefinitionsFrozen = errors.New("mysql saga: definitions frozen")
	// ErrDefinitionNotFound reports Run for an unregistered definition.
	ErrDefinitionNotFound = errors.New("mysql saga: definition not found")
	// ErrRuntimeNotStarted reports Run before successful Start.
	ErrRuntimeNotStarted = errors.New("mysql saga: runtime not started")
	// ErrRuntimeStarting reports a concurrent Start attempt.
	ErrRuntimeStarting = errors.New("mysql saga: runtime starting")
	// ErrRuntimeClosed reports use after Shutdown.
	ErrRuntimeClosed = errors.New("mysql saga: runtime closed")
)

// RuntimeConfig declares one MySQL/Redis-backed Saga runtime.
